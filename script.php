...
{
	protected $extension 	= 'com_phocaphoto';
	protected $updatetext 	= 'COM_PHOCAPHOTO_UPDATE_TEXT';
	protected $installtext 	= 'COM_PHOCAPHOTO_INSTALL_TEXT';
	protected $versiontext	= 'COM_PHOCAPHOTO_VERSION';
	protected $extensiontext= 'COM_PHOCAPHOTO';
	protected $configuretext= 'COM_PHOCAPHOTO_CONFIGURE';
