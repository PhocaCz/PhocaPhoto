...
echo '<div class="ph-cpanel-logo">'.JHtml::_('image', 'media/com_phocaphoto/images/administrator/logo-phoca-photo.png', 'Phoca.cz') . '</div>';
echo '<h3>'.JText::_($this->t['l'].'_PHOCA_PHOTO').' - '. JText::_($this->t['l'].'_INFORMATION').'</h3>'
	.'<div style="clear:both;"></div>';

echo '<h3>'.  JText::_($this->t['l'].'_HELP').'</h3>';

echo '<p>'
.'<a href="https://www.phoca.cz/phocaphoto/" target="_blank">Phoca Photo Main Site</a><br />'
.'<a href="https://www.phoca.cz/documentation/" target="_blank">Phoca Photo User Manual</a><br />'
.'<a href="https://www.phoca.cz/forum/" target="_blank">Phoca Photo Forum</a><br />'
.'</p>';
