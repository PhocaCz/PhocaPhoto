...
foreach ($this->views as $k => $v) {
	...
	echo $class::quickIconButton( $linkV, 'icon-48-'.$k.'.png', JText::_($v), $this->t['i']);
				...
				<div class="alert alert-block alert-warning ph-w80">
					<button type="button" class="close" data-dismiss="alert">×</button>
					<?php echo JText::_('COM_PHOCAPHOTO_NO_ADMINISTRATION'); ?>
				</div>
		...
		<div class="ph-cpanel-right">
			<div class="well">
                <?php echo '<div class="ph-cpanel-logo">'.JHtml::_('image', 'media/com_phocaphoto/images/administrator/logo-phoca-photo.png', 'Phoca.cz') . '</div>'; ?>
