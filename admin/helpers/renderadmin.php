...
class PhocaPhotoRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			case 'com_phocaphoto':
				$links[]	= array('Phoca Photo site', 'https://www.phoca.cz/phocaphoto');
				$links[]	= array('Phoca Photo documentation site', 'https://www.phoca.cz/documentation');
				$links[]	= array('Phoca Photo download site', 'https://www.phoca.cz/download');
			break;
