...
class PhocaPhotoRenderAdmin
{
	...
	public static function getLinks() {
		...
		switch ($option) {
			case 'com_phocaphoto':
				$links[]	= array('Phoca Photo site', 'http://www.phoca.cz/phocaphoto');
				$links[]	= array('Phoca Photo documentation site', 'http://www.phoca.cz/documentation');
				$links[]	= array('Phoca Photo download site', 'http://www.phoca.cz/download');
			break;
